...
CLEAN :
	...
	-@erase "$(INTDIR)\WzdDlg.obj"
	-@erase "$(INTDIR)\WzdDoc.obj"
	-@erase "$(INTDIR)\WzdView.obj"
	-@erase "$(INTDIR)\WzdWDlg1.obj"
	-@erase "$(INTDIR)\WzdWDlg2.obj"
...
"$(INTDIR)\WzdDlg.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Wzd.pch"
...
"$(INTDIR)\WzdWDlg1.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Wzd.pch"


SOURCE=.\WzdWDlg2.cpp

"$(INTDIR)\WzdWDlg2.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Wzd.pch"
