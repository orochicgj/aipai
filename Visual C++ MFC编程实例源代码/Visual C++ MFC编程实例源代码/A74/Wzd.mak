...
CLEAN :
	...
	-@erase "$(INTDIR)\WzdInfo1.obj"
	-@erase "$(INTDIR)\WzdInfo2.obj"
	-@erase "$(INTDIR)\WzdSlct.obj"
...
"$(INTDIR)\WzdInfo1.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Wzd.pch"


SOURCE=.\WzdInfo2.cpp

"$(INTDIR)\WzdInfo2.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Wzd.pch"


SOURCE=.\WzdSlct.cpp

"$(INTDIR)\WzdSlct.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Wzd.pch"
